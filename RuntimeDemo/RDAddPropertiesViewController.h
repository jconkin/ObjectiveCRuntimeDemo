//
//  RDAddPropertiesViewController.h
//  RuntimeDemo
//
...
/**
 *  Demonstrates adding properties to an object at run time
 */
@interface RDAddPropertiesViewController : UIViewController<UIPickerViewDataSource, UIPickerViewDelegate>
