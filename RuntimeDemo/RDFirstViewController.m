...
@interface RDFirstViewController () <UITextFieldDelegate>
...
- (void)setPropertyListInTextView {
    ...
    NSDictionary *temp_jconkin = [RDFirstViewController propertyTypeDictionaryOfClass:[NSObject class]];
...
- (void)updateAddDataTypeButtonText {
    ...
    [self.dataTypeButton setTitle:[RDFirstViewController getNameForDataTypeIndex:self.currentDataTypeToAdd]
...
- (IBAction)addProperty:(id)sender {
    ...
    NSString *dataTypeString = [NSString stringWithFormat:@"@\"%@\"", [RDFirstViewController getNameForDataTypeIndex:self.currentDataTypeToAdd]];
...
- (NSString *)pickerView:(UIPickerView *)pickerView
    ...
    return [RDFirstViewController getNameForDataTypeIndex:(DataTypeList)row];
}
